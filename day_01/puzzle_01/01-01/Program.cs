...
input.ForEach(str =>
{
    ...
    var firstDigit = Regex.Match(str, pattern);
    var lastDigit = Regex.Match(reversedStr, pattern);
    if (firstDigit.Success && lastDigit.Success)
    {
        var strIntConcat = $"{firstDigit.Value}{lastDigit.Value}";
